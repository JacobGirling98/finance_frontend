...
export const validateIsNotBlank = (field: string, value?: string): string =>
  isNotBlank(value) ? "" : `${field} is required`;
...
export const validatePersonalTransfer = (
  transaction: PersonalTransfer
): ValidationErrors<PersonalTransfer> => ({
