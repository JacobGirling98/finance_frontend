...
export const validateCreditDebitStandingOrder = (
  standingOrder: CreditDebitStandingOrder
): ValidationErrors<CreditDebitStandingOrder> => ({
  ...validateCreditDebit(standingOrder),
  ...validateFrequency(standingOrder.frequencyQuantity)
})

export const validateBankTransferStandingOrder = (
  standingOrder: BankTransferStandingOrder
): ValidationErrors<BankTransferStandingOrder> => ({
  ...validateBankTransfer(standingOrder),
  ...validateFrequency(standingOrder.frequencyQuantity)
})

export const validatePersonalTransferStandingOrder = (
  standingOrder: PersonalTransferStandingOrder
): ValidationErrors<PersonalTransferStandingOrder> => ({
  ...validatePersonalTransfer(standingOrder),
  ...validateFrequency(standingOrder.frequencyQuantity)
})

export const validateIncomeStandingOrder = (
  standingOrder: IncomeStandingOrder
